...
|
_
-> raise @@ TypeError"Bad argument type for print_s"
)
; ("get_string"
, fun vs ->
match vs with
...
module Frame= struct
  ...
  *)
  let lookup (eta : t) (x : Ast.Id.t) : Value.t =
    ...
    | Return _ -> impossible "Frame.lookup (Return _)"
  ...
  *)
  let reset (eta : t) (x : Ast.Id.t) (v : Value.t) : t =
    ...
    | Return _ -> impossible "Frame.reset (Return _)"
  ...
  *)
  let declare (eta : t) (x : Ast.Id.t) (v : Value.t) : t =
    ...
    | Return _ -> impossible "Frame.declare (Return _)"
  ...
  *)
  let push (eta : t) : t =
    ...
    | Return _ -> impossible "Frame.push (Return _)"
...
(* pop eta = Envs rhos, where eta = Envs (rho :: rhos).
  ...
  *)
  let pop (eta : t) : t =
    ...
    | Return _ -> impossible "Frame.pop (Return _)"
end
...
*)
  let rec eval (eta : Frame.t) (e : Ast.Expr.t) : Value.t =
    match e with
